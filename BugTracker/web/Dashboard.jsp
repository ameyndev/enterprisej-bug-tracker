    ...
    <body style="background-color:powderblue;">
        <div>
            ...
            <form>
                ...
                <input type="button" name="DeleteBugs" value="Delete Bug Report" onclick="location.href='DeleteBugs.jsp'">
            </form>
        <%
            ...
            out.println("<table><tr><th>Sr</th><th>Title</th><th>Description</th></tr>");
            int BugCount = 1;
            while (rs.next()) 
            {
                ...
                out.println("<tr><td>" + BugCount + "</td><td>" + title + "</td><td>" + desc + "</td></tr>");
                BugCount += 1;
            }
            ...
            while (rs1.next())
            {
                ...
                out.println("<tr><td>" + UnBugCount + "</td><td>" + title + "</td><td>" + desc + "</td></tr>");
                UnBugCount += 1;
            }
