    ...
    <body style="background-color:powderblue;">
        <div>
            ...
            <form>
                ...
                <input type="button" name="ResolveBugs" value="Resolve Bugs" onclick="location.href='ResolveBugs.jsp'">
            </form>
        <%
            ...
            out.println("<table><tr><th>Sr</th><th>Title</th><th>Description</th><th>Edit?</th></tr>");
            int BugCount = 1;
            while (rs.next()) 
            {
                ...
                out.println("<tr><td>" + BugCount + "</td><td>" + title + "</td><td>" + desc + "</td><td><a href='ResolveBugs.jsp'>Resolve</a></td>" + "</tr>");
                BugCount += 1;
            }
            out.println("</table><br><br>");    // End of table
