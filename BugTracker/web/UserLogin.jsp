...
//                PreparedStatement ps0 = c.prepareStatement("select * from BT_USERS where UNAME=? and upassword=? and uadmin=true");
//                ps0.setString(1, username);
//                ps0.setString(2, password);
//                ResultSet rs0 = ps0.executeQuery();
//                if(rs0.next())
//                {
//                    HttpSession AdminLoginSession = request.getSession(true);
//                    AdminLoginSession.setAttribute("user", username);
//                    RequestDispatcher rd0 = request.getRequestDispatcher("AdminDash.jsp");
